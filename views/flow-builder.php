                    ...
                    <div class="flex items-center justify-between p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                        <div>
                            <div class="fb-tooltip-wrap">
                                ...
                                <span class="fb-tooltip">Este nodo activará el flujo de agendamiento de citas</span>
                            </div>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Delega al asistente de citas</p>
                        </div>
                        <label class="relative inline-flex items-center cursor-pointer ml-2">
                            <input type="checkbox" id="node-requires-calendar" class="sr-only peer" onchange="onCalendarToggle()">
